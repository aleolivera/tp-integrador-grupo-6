...
public class ListViewMisNecesidadesAdapter extends ArrayAdapter<Necesidad>  {

    private List<Necesidad> listaNecesidades;
    private Context context;
    private int resourseLayout;
    Button btnModificarEstado;

    public ListViewMisNecesidadesAdapter(@NonNull Context context, int resource, @NonNull List<Necesidad> listaNecesidades) {
